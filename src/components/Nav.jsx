    ...
    <nav className='py-5 px-6 bg-gray-500 flex justify-between items-center'>
        ...
        <div className='gap-8 justify-end hidden md:flex'>
            ...
            <ul className='p-0 m-0 flex  gap-3'>
                <li className='px-3 py-2 list-none  hover:text-sky-600 cursor-pointer  hover:ring-teal-200 hover:bg-gray-700 rounded text-neutral-100'>Home</li>
                <li className='px-3 py-2 list-none  hover:text-sky-600 cursor-pointer hover:ring-teal-200 hover:bg-gray-700 rounded text-neutral-100'>Reviews</li>
                <li className='px-3 py-2 list-none hover:text-sky-600 cursor-pointer hover:ring-teal-200 hover:bg-gray-700 rounded text-neutral-100'>Subscription</li>
                <li className='px-3 py-2  list-none hover:text-sky-600 cursor-pointer hover:ring-teal-200 hover:bg-gray-700 rounded text-neutral-100'>Contact</li>
            </ul>
            <div>
